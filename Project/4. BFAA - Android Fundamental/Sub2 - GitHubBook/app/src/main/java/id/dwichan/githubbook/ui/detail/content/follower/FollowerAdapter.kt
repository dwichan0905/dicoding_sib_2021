...
import id.dwichan.githubbook.util.FollowerDiffUtilCallback

class FollowerAdapter : RecyclerView.Adapter<FollowerAdapter.UsersViewHolder>() {
    ...
    fun setUserList(users: List<UserItem>) {
        val callback = FollowerDiffUtilCallback(this.users, users)
