package id.dwichan.githubbook.ui.detail.options
...
class OptionsBottomSheet : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            val user = requireArguments().getParcelable<UserItem>(EXTRA_USER) as UserItem
    ...
    private fun getListOptions(user: UserItem): List<Option> {
        return listOf(
            Option(
    ...
    private fun shareUser(user: UserItem) {
